...
const SignUp = () => {
  ...
  //hanlde photoUrl change
  const hanlePhotoUrlChange = (e) => {
  ...
  //hanlde pasword change
  const handlePasswordChange = (e) => {
    setPassword(e.target.value);
  };
  //hanlde Confrim password change
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      if (isEmailValid && isEmailValid && isPasswordValid) {
  ...
  return (
    <div>
      {/* page Header */}
      <section className="bg-purple-500 relative bg-img">
        ...
        <div className="section-back-text">SignUp</div>
      </section>
      {/* -------------*/}
          ...
          <div className="w-full">
            <div className="bg-gray-100 text-gray-500 shadow-xl shadow-purple-500 w-full overflow-hidden">
              <div className="md:flex w-full">
                ...
                <div className="w-full md:w-1/2 py-10 px-5 md:px-10 bg-[#1d1c22] shadow-inner shadow-purple-500">
                  ...
                  <div>
                    <form onSubmit={handleSignUp}>
                      ...
                      <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                          ...
                          <div className="flex">
                            <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                              <i className="mdi mdi-email-outline text-white text-lg font-semibold"></i>
                            </div>
                            <input
                              type="text"
                              name="photourl"
                              className="w-full text-black font-semibold -ml-10 mt-2 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-purple-400"
                              placeholder="https://i.ibb.co/CmdNfgx/Passport-Size.jpg"
                              onChange={hanlePhotoUrlChange}
                            />
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="w-full sm:1/2 px-3 mb-12">
                          ...
                          <div className="flex">
                            ...
                            <input
                              type="password"
                              name="password"
                              className="w-full text-black font-bold mt-2 -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                              placeholder="************"
                    ...
                    <p className="text-center text-sm my-2 font-semibold ">
                      ...
                      <Link
                        to="/login"
                        className="text-[#FF3811] font-semibold underline ml-1"
                      >
                        LogIn
                      </Link>
                    </p>
