...
const FeaturedProducts = () => {
  ...
  return (
    <div class="bg-[#1d1c22] w-full min-h-[70vh] flex items-center py-10">
      <div class="w-full max-w-screen-xl mx-auto">
        <section class="w-full flex flex-col sm:flex-row items-center space-y-4 sm:justify-between">
          <div>
            <h1 class="font-bold text-4xl text-white">Featured Products</h1>
          </div>
          <div class="space-x-5">
            <button class="btn w-20 btn-warning" onClick={handlePrevClick}>
              Prev
            </button>

            <button class="btn w-20 btn-warning" onClick={handleNextClick}>
              Next
            </button>
          </div>
        </section>
        ...
        >
          <section class="flex items-center bg-gray-100 dark:bg-gray-800 lg:h-screen">
            <div class="p-4 mx-auto ">
              {[...Array(6).keys()].map((item) => (
                <SwiperSlide>
                  <div
                    key={item}
                    class="mt-56 w-full h-auto bg-white rounded shadow dark:bg-gray-700"
                  >
