...
const FeaturedProducts = () => {
  ...
  useEffect(() => {
    const response = axiosSecure.get('/products')
      .then(response => {
      ...
      <div className="w-full max-w-screen-xl mx-auto">
        <section className="w-full flex flex-col sm:flex-row items-center space-y-4 sm:justify-between">
          ...
          <div className="space-x-5">
            <button className="btn w-20 btn-warning" onClick={handlePrevClick}>
              Prev
            </button>

            <button className="btn w-20 btn-warning" onClick={handleNextClick}>
              Next
            </button>
          </div>
        </section>
