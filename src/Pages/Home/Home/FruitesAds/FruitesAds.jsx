    ...
    <div className="bg-[#1d1c22]">
      <div className="flex items-center max-w-screen-xl min-h-[100vh] mx-auto">
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
          <div class="rounded-lg bg-[#1d1c22] shadow-lg shadow-orange-400 p-5">
            <img
              className="w-5/6"
          ...
          <div class="rounded-lg bg-[#1d1c22] space-y-5 shadow-lg shadow-orange-400 p-5">
            ...
            <div className="space-y-8">
              ...
              <div className="sm:space-x-5">
                <a
                  class="inline-block rounded bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-[2px] hover:text-white focus:outline-none focus:ring active:text-opacity-75 transition hover:scale-110 "
                  href="/download"
                >
