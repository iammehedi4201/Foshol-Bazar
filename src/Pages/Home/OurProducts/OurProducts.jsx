        ...
        <section className="flex flex-col justify-center items-center space-y-4 ">
          ...
          <div className="z-10 text-center">
            <section>
              ...
              <h4 className="text-white text-xl">All the best items for you</h4>
            </section>
            <section className="w-full mt-5">
              <Tab.Group>
                <Tab.List className=" w-full flex sm:flex-row flex-col sm:justify-center sm:space-x-6  rounded-xl  p-1 mb-10 space-y-3 sm:space-y-0 ">
                  <Tab className="btn bg-orange-600 outline-0 border-0 hover:bg-orange-700 text-white">
                    Tending Produts
                  </Tab>
                  <Tab className="btn   text-white  bg-orange-600 outline-0 border-0  hover:bg-orange-700  ">
                    Best Products
                  </Tab>
                  <Tab className="btn  text-white bg-orange-600 outline-0 border-0   hover:bg-orange-700">
                    Discount Products
                  ...
                  <Tab.Panel className="text-white w-full">
                    <div class="grid grid-cols-1 gap-4 lg:gap-10 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
                      {[...Array(6).keys()].map((item) => (
                        <div
                          key={item}
                          class="overflow-hidden  bg-white rounded-lg shadow-xl shadow-red-600 dark:bg-gray-700 "
                        >
                          <a
                            href="#"
                            class="relative block h-60 overflow-hidden"
                          >
                            <img
                          ...
                          <div class="relative z-20 p-8 -mt-14 ">
                            <span class="inline-block px-4 py-2 mb-3 text-base font-bold text-white bg-blue-500 rounded">
                              $299.99
                            </span>
                            ...
                            <div class="flex items-center justify-between">
                              <div class="flex">
                                <button>
                                  <svg
                                    ...
                                    height="28"
                                    fill="currentColor"
                                    class="mr-4 text-blue-500 dark:text-blue-400"
                                    viewBox="0 0 16 16"
                                  >
                              ...
                              <button class="font-semibold text-blue-400 dark:text-blue-400">
                                {" "}
                                Add To Cart{" "}
                              </button>
                            </div>
