  ...
  return (
    <div className="bg-[#111827]">
      <div className=" max-w-screen-xl min-h-[100vh] mx-auto p-10">
        <section class="flex items-center ju min-h-screen bg-gray-100 font-poppins dark:bg-[#111827] ">
          <div class="justify-center flex-1 mx-auto max-w-7xl ">
            <div
              class="relative px-4 py-4 mx-4 bg-white bg-bottom bg-no-repeat bg-cover rounded-md  md:p-10 dark:bg-gray-900 shadow-indigo-600 shadow-lg"
              style={{
                minHeight: "580px",
            ...
            >
              <div class="absolute top-0 bottom-0 left-0 right-0 flex items-center ">
                <div class="max-w-3xl px-4 mx-auto text-center">
                  <a
                    class="inline-block mb-2 text-blue-500 dark:text-blue-400"
                    href="#"
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      class="w-10 h-10 bi bi-envelope-plus"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <div class="flex flex-wrap justify-center ">
                    ...
                    />
                    <button class="w-full btn px-6 py-4 text-sm font-semibold text-gray-100 bg-orange-500 rounded md:w-auto md:ml-2  dark:hover:bg-blue-500 hover:bg-blue-600">
                      Subscribe
                    </button>
                  </div>
                </div>
