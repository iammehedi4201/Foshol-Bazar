                                ...
                                <div className="flex flex-col-reverse py-20 -mx-4 lg:flex-row 2xl:py-40">
                                    ...
                                    <div className="w-full px-6 mb-8 lg:w-2/5 lg:mb-0 shadow-orange-500 shadow-lg ">
                                        ...
                                        <div className="flex items-center mb-6">
                                            <span
                                                className="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg dark:text-gray-400 dark:bg-gray-700">
                                            ...
                                            <p className="text-lg font-semibold text-gray-600 dark:text-gray-400">+977-014151678</p>
                                        </div>
                                        <div className="flex items-center mb-6">
                                            <span
                                                className="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg dark:text-gray-400 dark:bg-gray-700">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                    className="w-5 h-5 text-blue-600 dark:text-gray-400 bi bi-envelope" viewBox="0 0 16 16">
                                                    <path
                                                        d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                                                </svg>
                                            </span>
                                            <p className="text-lg font-semibold text-gray-600 dark:text-gray-400">abc@gmail.com</p>
                                        </div>
                                        <div className="flex items-center mb-6">
                                            <span
                                                className="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-4 bg-blue-100 rounded-lg dark:text-gray-400 dark:bg-gray-700">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                    className="w-5 h-5 text-blue-600 dark:text-gray-400 bi bi-geo-alt" viewBox="0 0 16 16">
                                                    <path
                                            ...
                                            <div>
                                                <p className="mb-2 text-lg font-semibold text-gray-600 dark:text-gray-400">Kathmandu,Nepal
                                                </p>
                                            </div>
                                        </div>
                                    </div>
