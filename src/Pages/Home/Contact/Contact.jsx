...
const Contact = () => {
    return (
        ...
        <div class="absolute bottom-0 left-0 hidden w-full h-full lg:block lg:w-6/12">
            ...
            <div class="max-w-5xl mx-auto">
                <div class="flex flex-col-reverse py-20 -mx-4 lg:flex-row 2xl:py-40">
                    <div class="w-full px-4 lg:w-3/5">
                        <div
                            class="w-full px-8 py-8 bg-white border rounded-md shadow-orange-500 shadow-inner dark:border-gray-800 dark:bg-gray-800 lg:ml-20 lg:max-w-md">
                            <form action="">
                                <div class="mb-6">
                    ...
                    <div class="w-full px-6 mb-8 lg:w-2/5 lg:mb-0 shadow-orange-500 shadow-lg ">
                        <span class="text-lg font-bold text-blue-500 dark:text-blue-400">Connect with us </span>
                        <h2 class="mt-6 mb-8 text-4xl font-bold md:mb-10 text-orange-500">Lets get connected</h2>
                        <div class="flex items-center mb-6">
                            ...
                            <p class="text-lg font-semibold text-gray-600 dark:text-gray-400">+977-014151678</p>
                        </div>
                        <div class="flex items-center mb-6">
                            <span
                                class="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg dark:text-gray-400 dark:bg-gray-700">
                            ...
                            <p class="text-lg font-semibold text-gray-600 dark:text-gray-400">abc@gmail.com</p>
                        </div>
                        <div class="flex items-center mb-6">
                            <span
                            ...
                            <div>
                                <p class="mb-2 text-lg font-semibold text-gray-600 dark:text-gray-400">Kathmandu,Nepal
                                </p>
                            </div>
                        </div>
                    </div>
