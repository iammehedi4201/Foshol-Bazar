  ...
  return (
    <div className="bg-[#1d1c22] relative">
      <div className="w-full max-w-screen-xl min-h-screen flex items-center justify-center mx-auto p-10">
        <div>
          <section class="flex items-center py-24 font-poppins bg-[#1d1c22] ">
            <div class="justify-center flex-1 px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
              <div class="mb-10 text-center">
                <span class="block mb-4 text-sm font-semibold leading-4 tracking-widest text-center text-blue-500 uppercase 0">
                  Team
                </span>
              ...
              <div class="grid grid-cols-1 gap-4 lg:gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-2">
                <a
                  class="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row bg-gray-800 shadow-lg shadow-[#0a4374]"
                  href="#"
                >
                  ...
                  <div class="relative flex self-center flex-1 p-8 ml-0 bg-white border rounded shadow dark:border-gray-700 dark:bg-gray-700 lg:items-center lg:-ml-12">
                    <div>
                      <h2 class="mb-2 text-xl font-bold dark:text-gray-300">
                        Henry Robinson
                      </h2>
                      <p class="mb-4 text-sm text-blue-500 dark:text-blue-400">
                        Director
                      </p>
                ...
                <a
                  class="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row shadow-lg shadow-[#0a4374] bg-gray-800"
                  href="#"
                >
                  <div class="w-full overflow-hidden lg:w-2/4 h-80">
                    <img
