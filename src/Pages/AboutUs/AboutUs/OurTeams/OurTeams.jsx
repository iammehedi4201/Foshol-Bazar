  ...
  return (
    <div className="bg-[#1d1c22] relative">
      <div className="w-full max-w-screen-xl min-h-screen flex items-center justify-center mx-auto p-10">
        <div>
          <section className="flex items-center py-24 font-poppins bg-[#1d1c22] ">
            <div className="justify-center flex-1 px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
              <div className="mb-10 text-center">
                <span className="block mb-4 text-sm font-semibold leading-4 tracking-widest text-center text-blue-500 uppercase 0">
                  Team
                </span>
