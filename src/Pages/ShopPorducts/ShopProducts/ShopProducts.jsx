...
const ShopProducts = () => {
  ...
  useEffect(() => {
    fetch(
      `http://localhost:3000/products?currentPage=${currentPage}&pageSize=${pageSize}&search=${searchValue}&category=${selectCategoryValue}`
    )
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div>
      ...
      <div className="bg-[#1d1c22] ">
        <div className=" max-w-screen-xl min-h-[100vh] mx-auto p-10">
            ...
            <section class="flex items-center ">
              <div class="p-4 mx-auto max-w-7xl">
                ...
                <section className="mb-5  ">
                  <form>
                    <div class="flex flex-col sm:flex-row sm:space-y-0 space-y-5 ">
                      ...
                      <div class="relative w-full">
                        <input onChange={handelSearch} type="search" id="search-dropdown" class="block p-2.5  w-full  h-12 z-20 text-sm text-gray-900  rounded-lg border-l-[#3abff8] border-l-2 border  focus:ring-[#3abff8] focus:border-[#3abff8] dark:bg-gray-700 dark:border-l-[#3abff8] 
                ...
                <div class="grid grid-cols-1 gap-4 lg:gap-10 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="">
                <section class="text-gray-600 body-font overflow-hidden">
                  <div className="w-full  flex justify-between p-4  bg-gray-100">
                    ...
                    <div className="sm:w-1/2 w-full ">
                      <h1 class="text-orange-700 mt-1 text-2xl font-bold ">
                        {selectedProduct.name}
                      </h1>
                      <p class="text-gray-800 mt-1 font-bold ">€1299</p>
                    </div>
                  </div>
                  <div class="p-4 flex flex-col items-center">
                    <div>
                      ...
                      <div class="inline-flex items-center mt-2">
                        ...
                        <div class="bg-gray-100 border-t border-b border-gray-100 text-gray-600 hover:bg-gray-100 inline-flex items-center px-4 py-1 select-none font-bold">
                          {quntity}
                        </div>
                        <button
            ...
            <section class="text-gray-600 body-font overflow-hidden">
              <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                  <img
                    alt="ecommerce"
                    class="lg:w-1/2 w-full h-auto sm:h-[50vh] object-cover object-center rounded "
                  ...
                  <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <h1 class="text-orange-500 text-3xl title-font font-medium mb-1">
                      {productDetails.name}
                    </h1>
                    <div class="flex mb-4">
                    ...
                    <div class="w-full flex justify-between items-center ">
                      <span class="title-font font-medium text-2xl text-orange-500 my-5">
                      ...
                      <button class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                        <svg
                          ...
                          stroke-linejoin="round"
                          stroke-width="2"
                          class="w-5 h-5 text-rose-600 hover:text-red-900"
                          viewBox="0 0 24 24"
                        >
