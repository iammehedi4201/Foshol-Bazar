    ...
    return (
        <div>
            <div className="drawer lg:drawer-open">
                ...
                <div className="drawer-side w-full z-20">
                    <label htmlFor="my-drawer-2" className="drawer-overlay"></label>
                    <div className=" h-full px-5 sm:w-[15vw] py-4 overflow-y-auto bg-[#D1A054]">
                        <h1 className='font-bold text-4xl uppercase mb-10  bg-slate-300  text-orange-500 rounded-lg shadow-2xl '>
                            <img src={logo} alt="" />
                        </h1>
                        {
                            isAdmin ? <>
                                ...
                                <ul className="space-y-2 font-medium ">
                                    <li className='flex justify-between items-center'>
                                        <div>
                                            <NavLink to="/dashboard/home" className="flex items-center  p-2 text-gray-900 rounded-lg   dark:hover:bg-gray-900 group hover:text-white">
                                                <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/additems" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span className="flex-1 ml-3 whitespace-nowrap font-bold uppercase">Add items</span>
                                        </NavLink>
                                    </li>
                                    <li>
                                        <NavLink to="/dashboard/manageitems" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/managebookings" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <span className="flex-1 ml-3 whitespace-nowrap font-bold uppercase">Manage Bookings</span>
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/alluser" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <li>
                                        <NavLink to="/login" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 16">
                                    ...
                                    <li>
                                        <NavLink to="/signup" className="flex items-center p-2 text-gray-900
                                        hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <ul className="space-y-2 font-medium ">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/reservation" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/payment" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/mycart" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/home" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/home" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
                                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3" />
                                            </svg>
                        ...
                        <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                            <li>
                                <NavLink to="/" className="flex items-center p-2 text-gray-900 hover:text-white transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700  group">
                                    <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <li>
                                <NavLink to="/dashboard/home" className="flex items-center p-2 text-gray-900 hover:text-white transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700  group">
                                    <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <g clipPath="url(#clip0_42_94)">
                                            <path d="M1.45898 5.92934H22.5414C23.3458 5.92934 24 5.27516 24 4.4707C24 3.66624 23.3458 3.01172 22.5414 3.01172H1.45898C0.654525 3.01172 0 3.66624 0 4.4707C0 5.27516 0.654525 5.92934 1.45898 5.92934Z" fill="currentColor" />
                                            <path d="M22.5414 10.541H1.45898C0.654525 10.541 0 11.1955 0 12C0 12.8045 0.654525 13.4586 1.45898 13.4586H22.5414C23.3458 13.4586 24 12.8045 24 12C24 11.1955 23.3458 10.541 22.5414 10.541Z" fill="currentColor" />
                                            <path d="M22.5414 18.0703H1.45898C0.654525 18.0703 0 18.7252 0 19.5296C0 20.3341 0.654525 20.9883 1.45898 20.9883H22.5414C23.3458 20.9883 24 20.3341 24 19.5296C24 18.7252 23.3458 18.0703 22.5414 18.0703Z" fill="currentColor" />
                                        </g>
                                        <defs>
                                    ...
                                    <span className="ml-3 font-bold uppercase">Menu</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/dashboard/home" className="flex items-center p-2 text-gray-900 hover:text-white transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700  group">
                            ...
                            <li>
                                <NavLink to="/dashboard/home" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700  group">
                                    <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-900 group-hover:text-gray-700 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
